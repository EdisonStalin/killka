odoo.define('oe_base.ListRenderer', function (require) {
"use strict";
...
ListRenderer.include({
    ...
    _computeColumnAggregates: function (data, column) {
        ...
        var func = (attrs.sum && 'sum') || (attrs.avg && 'avg') || (attrs.max && 'max') || (attrs.min && 'min') || false;
        if (func) {
            var count = 0;
            ...
            _.each(data, function (d) {
                ...
                //if (value !== 0) {
	            //    value = field_utils.parse.float(formatFunc(value, d.fields[attrs.name], {noSymbol: true}));
                //}
                // End by Smile
                if (func === 'avg') {
