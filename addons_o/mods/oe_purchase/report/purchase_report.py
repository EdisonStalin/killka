...
class PurchaseReport(models.Model):
    ...
    discount = fields.Float(string='Discount (%)', digits=dp.get_precision('Discount'), group_operator="avg")
    ...
    def init(self):
        ...
        # group by part
        view_def = view_def.replace('l.price_unit ', self._get_discounted_price_unit_exp(),)
        # Re-create view
