...
class AgedPartnerBalanceReportCompute(models.TransientModel):
    ...
    def print_report(self, report_type):
        self.ensure_one()
        if report_type == 'xlsx':
            report_name = 'oe_account_report.report_aged_partner_balance_xlsx'
        else:
            report_name = 'oe_account_report.report_aged_partner_balance_qweb'
    ...
    def _get_html(self):
        ...
        if report:
            rcontext['o'] = report
            result['html'] = self.env.ref('oe_account_report.report_aged_partner_balance').render(
                    rcontext)
        return result
