...
class JournalLedgerXslx(models.AbstractModel):
    _name = 'report.oe_account_report.report_journal_ledger_xlsx'
    ...
    def _get_report_filters(self, report):
        target_label_by_value = {
            value: label
            for value, label in
            self.env['account.print.journal']._get_move_targets()
        }

        sort_option_label_by_value = {
            value: label
            for value, label in
            self.env['account.print.journal']._get_sort_options()
        }
